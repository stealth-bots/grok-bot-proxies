...
export function GET(request: Request): Promise<Response> {
	return handleSlackRequest(request, envFromProcess());
}
...
export async function handleSlackRequest(request: Request, env: SlackEnv): Promise<Response> {
...
/** @deprecated Use handleSlackRequest. Kept so existing imports keep working. */
export const handleRequest = handleSlackRequest;
